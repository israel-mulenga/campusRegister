<?php
/**
 * Vue : Formulaire de Pré-inscription UDBL (Dynamique & Intelligent)
 * Emplacement : app/views/pre-inscription.php
 */
?>
...
<div class="container my-5">
    ...
    <div class="card shadow border-0 overflow-hidden bg-white mb-5">
        ...
        <form action="app/controller/traitement-inscription.php" method="POST" enctype="multipart/form-data" id="multiStepForm" class="p-4 p-md-5">
