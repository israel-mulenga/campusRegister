...
<body>
    ...
    <header>
        <nav class="container">
            ...
            <ul>
                ...
                <li><a href="app/views/inscription.php" class="btn-inscription">Inscription</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        ...
        <section id="hero">
            ...
            <a href="app/views/inscription.php" class="cta-button">Commencer ma pré-inscription</a>
        </section>
